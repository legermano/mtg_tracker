...
class ApplicationTranslator
{
    ...
    private function __construct()
    {
        ...
        $this->messages['en'][] = 'Formats';
        $this->messages['en'][] = 'Key';
        $this->messages['en'][] = 'Cards';
        $this->messages['en'][] = 'Card';
        $this->messages['en'][] = 'Set';
        $this->messages['en'][] = 'Sets';
        $this->messages['en'][] = 'Card Name';
        $this->messages['en'][] = 'Mana Cost';
        $this->messages['en'][] = 'Converted Mana Cost';
        $this->messages['en'][] = 'Loyalty';
        $this->messages['en'][] = 'Rarity';
        $this->messages['en'][] = 'Card Text';
        $this->messages['en'][] = 'Flavor Text';
        $this->messages['en'][] = 'Uncommon';
        $this->messages['en'][] = 'Common';
        $this->messages['en'][] = 'Rare';
        $this->messages['en'][] = 'Mythic';
        ...
        $this->messages['pt'][] = 'Formatos';
        $this->messages['pt'][] = 'Chave';
        $this->messages['pt'][] = 'Cartas';
        $this->messages['pt'][] = 'Carta';
        $this->messages['pt'][] = 'Coleção';
        $this->messages['pt'][] = 'Coleções';
        $this->messages['pt'][] = 'Nome da Carta';
        $this->messages['pt'][] = 'Custo de Mana';
        $this->messages['pt'][] = 'Custo de Mana Convertido';
        $this->messages['pt'][] = 'Lealdade';
        $this->messages['pt'][] = 'Raridade';
        $this->messages['pt'][] = 'Texto da Carta';
        $this->messages['pt'][] = 'Texto Ilustrativo';
        $this->messages['pt'][] = 'Incomum';
        $this->messages['pt'][] = 'Comum';
        $this->messages['pt'][] = 'Rara';
        $this->messages['pt'][] = 'Mítica';
