...
class DecksCardsNotOwnedReport extends TPage
{
    public function __construct()
    {
        ...
        $this->form->setFormTitle(_t("Decks - Cards not owned"));
    ...
    public function onGenerate()
    {
        try
        {
            ...
            $reportName = 'decks_card_not_owned_'.(ApplicationTranslator::getLanguage() == 'pt' ? 'ptbr' : 'en');
